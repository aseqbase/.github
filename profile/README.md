...
2. **Choose your deployment type**:
   - For multi-subdomain: use the `sequence` repo
   - For single-page: use the `single` repo
   - For CMS: use the `administrator` repo
...
4. **Configure your environment**:
   ...
   - Adjust PHP settings for accessibility
   - Customize content modules as needed
...
- 📧 Email: [info@aseqbase.ir](mailto:info@aseqbase.ir)
